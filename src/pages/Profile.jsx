    ...
    return(
        ...
        <div className="px-8 md:px-[200px] mt-8 flex md:flex-row flex-col-reverse md:items-start">
            ...
            <div className="flex justify-start md:justify-end items-start md:w-[30%] w-full md:items-end">
                ...
                <h1 className="text-xl font-boldmb-4">Profile</h1>
                <input type="text" className="outline-none px-4 py-2 text-gray-500" placeholder="Your user name" />
                <input type="email" className="outline-none px-4 py-2 text-gray-500" placeholder="Your user email" />
                <input type="password" className="outline-none px-4 py-2 text-gray-500" placeholder="Your user password" />
